...
aX:{
"^":"a;jO,Gx,fW,En<,EE<,um,PX,xF,UF,C9,lJ,Jp,ml,mf,pa,x8",
...
z.toString
P.L2(z,null,z,a,b)},function(a){return P.Z0(a,null)},null,"$2","$1","SD",2,2,3,4],
...
Zf:{
"^":"Tp:11;",
$1:function(a){return!!J.x(a).$iscv}}}],["todo","app.dart",,E,{
"^":"",
Iq:[function(){new E.S2(null,null,new E.US()).oo()},"$0","eE",0,0,1],
S2:{
"^":"a;of,MS,Th",
vn:function(){var z,y,x
for(z=0;y=J.OG(this.MS),z<y.gB(y);++z){y=P.EF(["title",J.nJ(J.OG(this.MS).t(0,z))],null,null)
x=window.localStorage
x.setItem("todo-dart",C.xr.KP(y))}},
MI:[function(a){var z,y
z=document.createElement("li",null)
z.textContent=J.Vm(this.of)
y=J.Vg(z)
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new E.oZ(z)),y.Sg),[H.Kp(y,0)]).Zz()
J.Fc(this.of,"")
J.OG(this.MS).h(0,z)
this.vn()},"$1","gIC",2,0,20],
oo:function(){this.of=document.querySelector("#todo-input")
this.MS=document.querySelector("#todo-list")
var z=J.uX(this.of)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(this.gIC()),z.Sg),[H.Kp(z,0)]).Zz()}},
oZ:{
"^":"Tp:11;a",
$1:function(a){return J.Mp(this.a)}},
US:{
"^":"a;"}},1],])
...
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"uJ",ret:P.a,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"aB",args:[null]},{func:"zx",args:[P.qU]},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"WW",void:true,args:[W.ea]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
O2.prototype=$desc
function aX(jO,Gx,fW,En,EE,um,PX,xF,UF,C9,lJ,Jp,ml,mf,pa,x8){this.jO=jO
this.Gx=Gx
this.fW=fW
this.En=En
this.EE=EE
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
function S2(of,MS,Th){this.of=of
this.MS=MS
this.Th=Th}S2.builtin$cls="S2"
...
if($desc instanceof Array)$desc=$desc[1]
US.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,FO,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,KD,Ln,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,zD,Ul,KK,As,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,QG,BR,vw,aG,J6,Oi,Xg,UM,hq,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Y0,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,QU,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,yu,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,zU,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UD,ZD,vt,wD,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,wx,P0,Jq,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,NY,cC,RA,IY,JH,jl,bL,w6,yk,WK,hI,vK,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,C6,Ca,b8,Pf,Lj,vs,da,pV,U7,rH,eX,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,lU,xp,MO,Kd,UO,Bc,VT,of,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,dR,uR,QX,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,b6,tj,zQ,u3,mW,LU,E9,lD,LG,Sw,o0,Ma,Vj,Uk,wI,Ud,K8,by,oj,Sh,CL,a2,CP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,KN,An,zM,c8,lf,a,mE,qU,Rn,wv,VG,zL,ec,e7,dx,x5,cX,DE,Fk,RO,Cq,xC,Pb,W9,IU,b0,Pg,Ob,GV,D7,Zf,S2,oZ,US]}