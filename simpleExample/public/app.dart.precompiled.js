...
z=W.Kn("monsters.json",null,null).ml(S.i9()).ml(new S.A1())
y=$.X3
x=P.VH(new S.lI(),y)
y.toString
z.au(H.VM(new P.vs(0,y,null,null,null,null,x,null),[null]))},"$1","qv",2,0,1],
Iq:[function(){var z=document.querySelector("#create-monster-btn")
$.ph=z
z=J.Vg(z)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(S.qv()),z.Sg),[H.Kp(z,0)]).Zz()},"$0","eE",0,0,2],
wD:{
"^":"a;aO,i5",
bu:function(a){return H.d(this.aO)+" "+H.d(this.i5)},
i9:function(){var z,y
z=$.GZ()
y=$.eU()
this.aO=J.UQ(z,y.j1(J.q8(z)))
z=$.J2()
this.i5=J.UQ(z,y.j1(J.q8(z)))},
static:{"^":"Rv,LG,Wa",iN:[function(a){var z,y
z=C.xr.kV(a)
y=J.U6(z)
$.LG=y.t(z,"firstNames")
$.Wa=y.t(z,"surnames")},"$1","i9",2,0,0]}},
A1:{
"^":"Tp:12;",
$1:function(a){var z=new S.wD(null,null)
z.i9()
document.querySelector(".monster-name").textContent=H.d(z.aO)+" "+H.d(z.i5)}},
lI:{
"^":"Tp:12;",
$1:function(a){P.JS("Something went wrong "+H.d(a))}}},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
$.jk().scheduleImmediate(H.tR(new P.C6(a),0))},"$1","Sx",2,0,3],
Bz:[function(a){P.jL(C.RT,a)},"$1","K7",2,0,3],
...
z.toString
P.L2(z,null,z,a,b)},function(a){return P.SZ(a,null)},null,"$2","$1","AY",2,2,5,6],
...
z.CG(a,b)},function(a){return this.w0(a,null)},"pm","$2","$1","gYJ",2,2,16,6]},
vs:{
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"Lp","$2","$1","gbY",2,2,5,6],
OH:function(a){var z
...
xv:[function(a){return H.CU(a)},"$1","jC",2,0,10],
...
I.$lazy($,"indexGen","Rv","eU",function(){return C.pr})
I.$lazy($,"firstNames","LG","GZ",function(){return[]})
I.$lazy($,"surnames","Wa","J2",function(){return[]})
...
init.metadata=[{func:"xM",void:true,args:[P.qU]},{func:"WW",void:true,args:[W.ea]},{func:"X0",void:true},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"aB",args:[null]},{func:"zx",args:[P.qU]},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"uu",void:true,args:[P.a],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
VX.prototype=$desc
function wD(aO,i5){this.aO=aO
this.i5=i5}wD.builtin$cls="wD"
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,Ny,QQ,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,FO,xf,Vb,ST,zU,wa,tb,pA,Mi,KD,Ln,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,zD,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,FH,y6,RH,ho,Z2,QG,BR,vw,aG,J6,Oi,r0,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Y0,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,QU,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,lc,Xu,lu,tk,me,oB,Ah,yu,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UM,ZD,vt,GN,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,wx,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,NY,cC,RA,IY,JH,jl,bL,w6,yk,WK,hI,vK,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,wD,A1,lI,a7,i1,xy,MH,SU,C6,Ca,b8,Pf,Zf,vs,da,pV,U7,rH,cX,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,lU,xp,MO,Kd,UO,Bc,VT,of,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,dR,uR,QX,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,b6,tj,zQ,u3,mW,lD,fO,Sw,o0,Ma,Vj,JC,f1,Uk,wI,by,QM,CL,a2,CP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,EH,KN,An,zM,c8,lf,a,mE,qU,Rn,wv,Kx,hH,bU,Fk,RO,Cq,xC,IU,mg,b0,Pg,Ob,GV]}